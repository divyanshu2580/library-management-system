...
def update_record():
	...
	edit = Button(left_frame, text='Update Record', font=btn_font, bg=btn_hlb_bg,fg='white', width=20, command=update)
...
root.resizable(0, 0)
Label(root, text= ' (:       K I T T Y     L I B R A R Y        :) ', font=("Times New Roman", 18, 'bold'), bg=btn_hlb_bg, fg='White').pack(side=TOP, fill=X)
bk_status = StringVar()
bk_name = StringVar()
bk_id = StringVar()
...
dd.configure(font=entry_font, width=20,bg='Slateblue4',fg='ghostwhite',anchor=CENTER)
dd.place(x=45, y=300)
submit = Button(left_frame, text='Add new record', font=btn_font, bg=btn_hlb_bg, width=20, fg='white',command=add_record)
submit.place(x=50, y=375)
clear = Button(left_frame, text='Clear fields', font=btn_font, bg=btn_hlb_bg, width=20,fg='white', command=clear_fields)
clear.place(x=50, y=435)
Button(RT_frame, text='Delete book record', font=btn_font, bg=btn_hlb_bg, width=17,fg='white', command=remove_record).place(x=8, y=30)
Button(RT_frame, text='Delete full inventory', font=btn_font, bg=btn_hlb_bg, width=17,fg='white', command=delete_inventory).place(x=178, y=30)
Button(RT_frame, text='Update book details', font=btn_font, bg=btn_hlb_bg, width=17,fg='white',
       command=update_record).place(x=348, y=30)
Button(RT_frame, text='Change Book Availability', font=btn_font, bg=btn_hlb_bg, width=19,fg='white',
       command=change_availability).place(x=518, y=30)
Label(RB_frame, text='B O O K      I N V E N T O R Y', bg=rbf_bg, fg='white', font=("Times New Roman", 15, 'bold')).pack(side=TOP, fill=X)
...
tree.column('#1', width=200, stretch=NO,anchor=CENTER)
tree.column('#2', width=75, stretch=NO,anchor=W)
tree.column('#3', width=155, stretch=NO)
tree.column('#4', width=115, stretch=NO)
